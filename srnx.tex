...
\begin{bytefield}[bitwidth=1.1em]{32}
	...
	\begin{rightwordgroup}{Payload}
		...
		\wordbox{3}{... compressed block data ...}
	\end{rightwordgroup} \\
	\begin{rightwordgroup}{Digest}
		\wordbox{1}{CRC-32C}
	\end{rightwordgroup}
...
This results in a runtime approximately 50\% longer than
\texttt{RNX2CRX}.
...
CRINEX & 4.1709 & 100.43 & RNXCMP v4.2.0 \\
CRINEX + gzip & 11.7922 & 1036.79 & gzip v1.14, -9 \\
CRINEX + bzip3 & 17.5041 & 662.26 & bzip3 v1.5.3 \\
SRNX & 19.4568 & 149.65 & this work \\
SRNX + bzip3 & 19.7888 & 464.08 & \\
SRNX + zpaq & 19.9669 & 3310.59 & zpaq v7.15, -m56 \\
30 s & 15.2707 & 62.71 & teqc 2019Feb25 \\
30 s + CRINEX & 50.8202 & 132.88 & \\
30 s + CRINEX + gzip & 133.4279 & 266.67 & \\
30 s + SRNX & 207.6444 & 137.87 & \\
30 s + SRNX + pcompress & 216.7108 & 105.46 & pcompress v3.1, -a -l 14 -D -G -L -s 64m \\
30 s + SRNX + zpaq & 219.8175 & 505.82 & \\
\end{tblr}
\end{table}
